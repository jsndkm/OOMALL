...
public class UnAuthorizedController {
    ...
    public ReturnObject findProductById(@PathVariable("id") Long id, @RequestParam(value="flag",defaultValue = "0")Integer flag) {
    ...
    public ReturnObject getCategoryProduct(   @PathVariable Long id,
        ...
        List<SimpleProductDto> collection=OnsaleList.stream().map(product -> new SimpleProductDto(product)).collect(Collectors.toList());
        PageDto<SimpleProductDto> ret = new PageDto<>(collection, page, pageSize);
